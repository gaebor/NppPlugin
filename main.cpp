	...
	if (notifyCode->nmhdr.hwndFrom == nppData._nppHandle)
	{
		switch (notifyCode->nmhdr.code)
		{
			case NPPN_TBMODIFICATION:
			{
				...
				//NLChangeNppMenu((HINSTANCE)MyNppPlugin::ME()->hModule, nppData._nppHandle, NPP_PLUGIN_NAME, funcItem, nbFunc);

				MyNppPlugin::ME()->InitIcon();
				break;
			}
			case NPPN_READY:
			{
